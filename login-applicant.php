...
<!DOCTYPE html>
<html lang="en">
<?php include('process/applicant-login.php')?>
...
<head>
    ...
    <link href="../Pages/css/loginform.css" rel="stylesheet"
    >
    <link href="../Pages/css/login.css" rel="stylesheet">
    <link href="../Pages/css/loginstyle.css" rel="stylesheet">
    <link href="../Pages/css/owl.carousel.min.css" rel="stylesheet">
    <link href="../Pages/css/bootstrap1.min.css" rel="stylesheet">
</head>

<body style="background-image:url('img/Website Background.png');">
    <!-- Spinner Start -->
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow-sm px-5 py-3 py-lg-0">
        <a href="../Pages/Applicant-Dashboard.php" class="navbar-brand p-0" id="logoform">
            <img class="w-100" src="img/Work-Global-Logo-small.png" alt="Image" id="logologin">
        </a>
    </nav>
    <!-- Navbar End -->
<!-- Content start style="background-color:#33475b" -->
 <!--Login Start-->
 <div id="login-form">
...
<span toggle="#password-field" class="fa fa-fw fa-eye field-icon toggle-password" id="toggle-eye"></span>
