    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow-sm px-5 py-3 py-lg-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-0">
                ...
                <a href="jobofferlis.php" class="nav-item nav-link">Job Offer list</a>
                ...
                <a href="process/logout.php" class="nav-item nav-link">Logout</a>
            </div>
        </div>
    </nav>
    <!-- Navbar End -->
            ...
            <div class="row g-5">
                <div class="col-lg-7">
                    <div class="section-title mb-4">
                        ...
                        <!-- Membership of Employer -->
                        <form name="form" action="process/activate-membership.php" enctype="multipart/form-data"method="post">
                         <?php
                         include('process/viewinfo-employer.php'); 
                         ?>
                         <!-- Membership cost -->
                         <table id="membership"><tr><td><input type="radio" name="membership" value="yearly"><label>1 Year Membership/Cost: 400$</label></td></tr></table>
                         <table id="membership2"><tr><td><input type="radio" name="membership" value="quarterly"><label>3 Month Membership/Cost: 100$</label></td></tr></table>
                         <table id="membership3"><tr><td><input type="radio" name="membership" value="monthly"><label>1 Month Membership/Cost: 50$</label></td></tr></table>
                         <br><br>
                         <input type="submit" name="Submit" id="Activate" value="Activate">
                     </form>
                    </div>
                </div>
            </div>
