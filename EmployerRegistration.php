...
<body style="background:#3B6993">
  ...
  <div id="firstPage" >
  <form name="form" action="process/membership.php" method="post">
    <br><h1>Company Information</h1>
    <!-- firstname text field -->
    <label>Company Head/Ceo/President name: </label><input type="text" name="companyowner" id="fname" required placeholder="Company Head/Ceo/President name" onkeydown="return /[a-z, ]/i.test(event.key)" />
    
    <!-- middle name text field-->
    <label>Representative Name: </label><input type="text" name="Representative" id="mname" placeholder="Representative Name" onkeydown="return /[a-z, ]/i.test(event.key)" />
    
    <!-- Email text field-->
    <label>Email: </label><input type="text" name="email" id="email" required placeholder="Email                                           Example:smc2023@gmai.com"/>

    <!-- Contact text field-->
    <label>Contact: </label><input type="text" name="contact" id="contact" required/>
    
    <!-- birdth date date field -->
    <label>Company Name: </label><br><input type="text" name="comname" id="fname">
    

    <!-- Start permanent address -->
    <label>Permanent Address Of Company: </label><input type="text" name="paddress" id="paddress" placeholder="No. of House, Street, Unit, Buildng No./Name" required>
    ...
    <label>Country Of Company: </label>
    ...
    <label>Employer Number: </label><input type="text"value="<?php include('process/EMP-id.php')?>"  disabled/>
    <input type="hidden" name="Employernum" id="Employernum" value="<?php include('process/EMP-id.php')?>" /><br> <br> 
    <!-- Username text field -->
    ...
    <br><br>
  <input type="submit" name="submit" id="mregistration"/></form>
  </div>

<button id="btn1" onclick="myFunction()">Next</button>
<button id="btn2" onclick="myFunction()" style="display: none;">Back</button>
    </div></div></div></div></div>
</div><br><br><br>
    <!-- Sign-up End -->
